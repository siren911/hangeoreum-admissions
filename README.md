...
- 2026 입결 대시보드: 한의대·치대·의대 31개 전형의 공개 결과와 출처, 평균·70%·80% 통계 구분. 대학 공개 점수와 별도 계산한 국수탐 평균 백분위, 과목별 공개 등급·계산식을 함께 표시.
  - 2026-09-21 추가 확인: 입결 29개 전형, 국수탐 평균 백분위 25개 전형. 나머지는 과목별 자료 부족 2개·원문 수치 확인 필요 2개·대학 성적 비공개 2개로 구분.
